...
// playwright-core 1.62+ ships a bundled server layout; deviceDescriptorsSource.json
// no longer exists as a standalone asset. Keep only files that are still present.
